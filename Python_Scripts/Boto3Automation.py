...
def get_config():
    ...
    return {
        ...
        "bucket_name": "mandarpdevops",
        "index_file": "index.html",
        "local_repo_path": "/home/mandar/DevOps/Monitoring-Scaling-and-Automation/HTML/index.html",
        "base_ami_id": "ami-0669fb29385f494a4",
        "email": "mandarphadke1434@gmail.com",  # Add your email here
    }
...
def create_auto_scaling_group(config, ami_id, tg_arn):
    ...
    launch_config_name = "mp-webapp-launch-config"
...
sudo systemctl restart nginx
    ...
    try:
        autoscaling.create_auto_scaling_group(
            AutoScalingGroupName="mp-webapp-asg",
            LaunchConfigurationName=launch_config_name,
            MinSize=2,
            MaxSize=5,
            DesiredCapacity=2,
...
def create_sns_topic_and_subscription(sns_client, email):
    ...
    try:
        response = sns_client.create_topic(Name="mp-webapp-notifications")
...
def create_cloudwatch_alarm(topic_arn, tg_arn):
    ...
    try:
        cloudwatch.put_metric_alarm(
            AlarmName="mp-webapp-unhealthy-instance-alarm",
            ...
            Dimensions=[
                ...
                {"Name": "LoadBalancer", "Value": "mp-webapp-lb"},
            ],
...
def main():
    ...
    wait_for_asg_instances("mp-webapp-asg")
