...
def get_config():
    ...
    config = {
        ...
        "security_group": "launch-wizard-7",  # Replace with your Security Group ID
        ...
        "bucket_name": "mandarpdevops",  # Replace with unique S3 bucket name
        "email": "mandarphadke1434@gmail.com",  # Replace with your email for SNS notifications
    }
    return config
...
def main():
    ...
    # delete_ami_by_name("mp-nginx-webapp-ami")
    delete_ami_by_name("mp-nginx-webapp-ami")
    instance_id = "i-054ffd93f372aa14c"
    ami_id = "ami-0669fb29385f494a4"
    lb_arn = "arn:aws:elasticloadbalancing:us-west-2:975050024946:loadbalancer/app/mp-webapp-lb/dd4eefc4e51001c3"
    tg_arn = "arn:aws:elasticloadbalancing:us-west-2:975050024946:targetgroup/mp-webapp-target-group/09c8322da6dcac7c"
    asg_name = "mp-webapp-asg"
    lc_name = "mp-webapp-launch-config"
